...
export default function VerUsuario() {
  ...
  return (
    <div>
      <PageMeta
        title="Usuário | WhatsApp Manager"
      ...
      <CabecalhoPagina
        ...
        acoes={
          <>
            ...
            {registro && temPermissao("usuario.editar") && (
              <Link
                to={`/usuarios/${registro.id}/editar`}
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] xl:p-6">
        ...
        {!carregando && registro && (
          <dl>
            ...
            <ItemDetalhe rotulo="E-mail">{registro.email}</ItemDetalhe>
            <ItemDetalhe rotulo="Telefone">
              {ouTraco(registro.telefone)}
            </ItemDetalhe>
            <ItemDetalhe rotulo="Tipo de usuário">
